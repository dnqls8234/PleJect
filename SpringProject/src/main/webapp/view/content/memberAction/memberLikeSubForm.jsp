...
<body>
			...
			<div class = "likeWrap">
				<form name = "like" id = "like" method = "post" action = "memberLikeSubPro">
...
<!-- 					<p class ="memo">최대 <script>document.write(maxChecked);</script> 까지만 선택할 수 있습니다.</p> -->
					<div class = "likelike">
						...
						<c:if test = "${status.count  == interestList.interNum}">
							<div class = "likelist">
								<div class = "interestList">
									<input type="checkbox" id="likes${status.count}" name = "likes"  value = "${interestList.interestName}" onclick=check${status.count}(this) >
